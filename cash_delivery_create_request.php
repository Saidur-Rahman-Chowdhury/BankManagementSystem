...
if (($result->num_rows) > 0) {
    ...
    $body = "Your money delivery request is placed. Delivery Man ".$row["name"]." with contact number ".$row["phone"]." is assigned for this delivery process. Your OTP is ".$otp."";
...
<body>
    ...
    <div class="flex-container">
        <div class="flex-item">
            <?php
            if ($err_no == -2) { ?>
                <p id="info"><?php echo "".$sql0." Your money delivery cannot be placed now. Currently our every delivery man is busy. Please try again later.\n"; ?></p>
            <?php } ?>
